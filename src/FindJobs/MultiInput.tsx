  ...
  return (
    <Combobox store={combobox} onOptionSubmit={handleValueSelect} withinPortal={false}>
      <Combobox.DropdownTarget>
        ...
        leftSection={
            <div className='flex items-center bg-mine-shaft-700 p-1 rounded-full text-bright-sun-400 '> <props.icon/></div>
        }
        >
          <Pill.Group>
            {value.length > 0 ? (
              ...
              <Input.Placeholder className='!text-mine-shaft-200 font-bold text-xl ml-2'>{props.title}</Input.Placeholder>
            )}
          </Pill.Group>
        </PillsInput>
      </Combobox.DropdownTarget>
